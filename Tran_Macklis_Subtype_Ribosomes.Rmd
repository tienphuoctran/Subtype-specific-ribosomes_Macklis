...
ggplot(df_wide_BH_annotate_RP_pval, mapping = aes(x= Cal_vs_Sub_diff, y= -log10(Cal_vs_Sub_p.val), label = name)) + 
  geom_point(aes(color = Cal_vs_Sub_p.val <= 0.01), alpha = 0.7) + 
  geom_text_repel(data = subset(df_wide_BH_annotate_RP_pval, Cal_vs_Sub_p.val <= 0.01 & Cal_vs_Sub_diff > 0), 
...
### Output differential analysis results
df_wide_BH_annotate_output_RP <- df_wide_BH_annotate_RP %>% select(Accession, name, "Sub_1", "Sub_2", "Sub_3", "Sub_4", "Sub_5", "Cal_1", "Cal_2", "Cal_3", "Cal_4", Cal_vs_Sub_diff, Cal_vs_Sub_p.val, Cal_vs_Sub_BH, Group)
colnames(df_wide_BH_annotate_output_RP) <- c("UniProt_Accession", "Gene", "SCPN_rRNA_Rep1", "SCPN_rRNA_Rep2", "SCPN_rRNA_Rep3", "SCPN_rRNA_Rep4", "SCPN_rRNA_Rep5", "CPN_rRNA_Rep1", "CPN_rRNA_Rep2", "CPN_rRNA_Rep3", "CPN_rRNA_Rep4", "Log2(CPN_rRNA/SCPN_rRNA)", "CPN_rRNA_vs_SCPN_rRNA_p.val", "CPN_rRNA_vs_SCPN_rRNA_p.adj", "Protein Group")
